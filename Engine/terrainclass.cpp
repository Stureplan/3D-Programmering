...
void TerrainClass::RenderBuffers(ID3D10Device* device)
{
	...
	// Set the index buffer to actice in the input assembler so it can be rendered
	device->IASetIndexBuffer(m_indexBuffer, DXGI_FORMAT_R32_UINT, 0);

	// Set the type of primitive that should be rendered from this vertex buffer, in this triangles
